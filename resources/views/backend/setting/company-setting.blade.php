        ...
        <form
            ...
            <div class="row">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="deskripsi" class="form-control" rows="3">{{ old('deskripsi', $companySetting->deskripsi ?? '') }}</textarea>
                                @error('deskripsi')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="alamat" class="form-control" rows="3">{{ old('alamat', $companySetting->alamat ?? '') }}</textarea>
                                @error('alamat')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <textarea name="peta_lokasi" class="form-control" rows="5">{{ old('peta_lokasi', $companySetting->peta_lokasi ?? '') }}</textarea>
                                @error('peta_lokasi')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Catatan Pengiriman</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label">Catatan Pengiriman</label>
                                <textarea name="catatan" class="form-control @error('catatan') is-invalid @enderror" rows="6" id="content"
